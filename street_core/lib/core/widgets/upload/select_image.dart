...
class _ImagePickerWidgetState extends State<ImagePickerWidget> {
  ...
  Future<void> _pickImage(ImageSource source) async {
    ...
    try {
      ...
      _showError(context.tr(LocaleKeys.mediaErrorSelectingImage));
    } finally {
      if (mounted) {
        setState(() => _isLoading = false);
      }
  ...
  void _showError(String message) {
    if (mounted) {
      SnackBarHelper.showError(context, LocaleKeys.mediaErrorSelectingImage);
    }
  }
          ...
          child: Column(
            ...
            children: [
              ListTile(
                ...
                title: const MyText(LocaleKeys.mediaSelectTakePhoto),
                onTap: () {
              ...
              ListTile(
                ...
                title: const MyText(LocaleKeys.mediaSelectFromGallery),
                onTap: () {
                  Navigator.pop(context);
                  _pickImage(ImageSource.gallery);
                },
              ...
              ListTile(
                ...
                title: const MyText(LocaleKeys.mediaUploadCancel),
        ...
        SizedBox(
          ...
          child: OutlinedButton.icon(
            ...
            label: MyText(
              _isLoading
                  ? LocaleKeys.mediaImageProcessing
                  : (_hasImage ? LocaleKeys.mediaImageChange : LocaleKeys.mediaImageSelect),
            ),
