// lib/core/widgets/upload/upload_progress_dialog.dart
...
class UploadProgressDialog extends StatelessWidget {
  const UploadProgressDialog({
    ...
    this.messageKey = LocaleKeys.mediaUploadUploading,
    this.onCancel,
    this.fileInfo,
  });
      ...
      actions: onCancel != null
          ? [
              TextButton(
                ...
                child: const MyText(LocaleKeys.mediaUploadCancel),
              ),
            ]
          : null,
    );
              ...
              children: [
                ...
                Expanded(
                  child: filename != null
                      ...
                      : const MyText(LocaleKeys.mediaUploadUploading, fontWeight: FontWeight.w500),
                ),
                Text(
                  '${(progress * 100).toStringAsFixed(0)}%',
                  style: TextStyle(
...
class UploadSuccessDialog extends StatelessWidget {
  const UploadSuccessDialog({
    super.key,
    this.messageKey = LocaleKeys.mediaUploadComplete,
    this.fileCount = 1,
    this.onDone,
  });
    ...
    return AlertDialog(
      ...
      content: Column(
        ...
        children: [
          ...
          SizedBox(height: AppSpacing.sm),
            MyText(
              LocaleKeys.mediaUploadFilesUploadedCount,
      ...
      actions: [
        TextButton(
          ...
          child: const MyText(LocaleKeys.mediaActionDone),
        ),
      ],
    );
  }
...
class UploadErrorDialog extends StatelessWidget {
  const UploadErrorDialog({
    super.key,
    this.messageKey = LocaleKeys.mediaUploadFailed,
    this.details,
    this.onRetry,
    this.onCancel,
  });
      ...
      actions: [
        ...
        if (onRetry != null)
          ElevatedButton(
            ...
            child: const MyText(LocaleKeys.mediaUploadRetry),
          ),
      ],
    );
  }
